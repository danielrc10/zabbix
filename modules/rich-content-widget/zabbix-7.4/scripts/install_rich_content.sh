...
readonly SOURCE_DIR="${PROJECT_DIR}/module/rich_content"
readonly MODULE_NAME="rich_content"
...
usage() {
	printf '%s\n' \
		'Uso: install_rich_content.sh [--modules-dir PATH] [--backup-dir PATH] [--dry-run]' \
...
staging=""
trap - EXIT
printf '%s\n' 'Módulo instalado. Escaneie e habilite Conteúdo rico em Administração → Geral → Módulos.'
